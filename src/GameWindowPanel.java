...
public class GameWindowPanel extends JPanel{
  ...
  GameWindowPanel(GameStatus boardStatus){
  ...
  public void addLabel() {
	  ...
	  scoreButton = new MyButton("Score: " + Player.getInstance().getScore());
	  scoreButton.setBounds((int)width - 900, (int)height - 100, 250, 50);
	  scoreButton.setFont(new Font("Courier New", Font.BOLD, 30));
	  this.add(scoreButton);
	  
	  lifeButton = new MyButton("Life: " + Player.getInstance().getLivesRemaining());
  ...
  public void paintBackground(){
    ...
    // draw farm
    farm = new ImageIcon("./data/farm.jpg");
  ...
  public void updatePanel() {
    ...
    scoreButton.setText("Score: " + Player.getInstance().getScore());
    lifeButton.setText("Life: " + Player.getInstance().getLivesRemaining());
    repaint();
    keyLeftRight = 0;
  }
}
